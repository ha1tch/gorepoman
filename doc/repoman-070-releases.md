...
```
$ python3 syncver.py show
version: 0.1.0  sync: ok

$ python3 syncver.py bump-minor
...
```
$ python3 relcore.py 0.2.0 --resume
...
```json
{"name": "go-sanity", "run": "python3 gomod.py check", "always": true}
```
